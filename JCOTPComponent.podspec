...
spec.source                = { :git => "https://github.com/jasminceco/JCOTPComponent.git", :tag => s.version }
# spec.source                = { :http => 'https://github.com/jasminceco/JCOTPComponent/blob/main/JCOTPComponent.xcframework.zip' }
